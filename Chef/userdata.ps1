<powershell>
 ...
 $env:CHEF_SERVER_NAME = "My-Chef" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "my-chef-keidr14qipipvvnw.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
