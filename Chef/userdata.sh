...
CHEF_SERVER_NAME="My-Chef" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="my-chef-keidr14qipipvvnw.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
